...
<html>
	...
	<div>
      ...
      <div class="panel-heading"><span class="statementHeading">Statement covering <g:formatDate date="${bill.startDate}" type="date" style="MEDIUM"/> to <g:formatDate date="${bill.endDate}" type="date" style="MEDIUM"/></span></div>
        <div class="panel-body">
          <h4 class="totalCostDetail"><span class="text-danger"><g:formatNumber number="${bill.totalCost}" type="currency" currencyCode="GBP"/></span> due on <g:formatDate date="${bill.dueDate}" type="date" style="MEDIUM"/></h4>
        <div>
      </div>
    </div>
    ...
    <div class="panel collapsablePanels">
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title packageHeading">
        ...
        <div class="clearfix">
          <a role="button" class="pull-right subscriptionViewToggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
            Show subscriptions
        ...
        <ul class="list-unstyled">
          ...
          <li class="${subscription.type}">
            <h5>
              ...
              <span class="subscriptionDetail">${subscription.name} for <g:formatNumber number="${subscription.cost}" type="currency" currencyCode="GBP"/></span>
            </h5>
          </g:each>
          </li>
        </ul>
      ...
      <div class="panel-heading" role="tab" id="headingThree">
        <h4 class="panel-title storeHeading">
        ...
        <div class="clearfix">
          <a role="button" class="pull-right storeViewToggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
      ...
      <div class="panel-heading" role="tab" id="headingOne">
        <h4 class="panel-title callsHeading">
          <span class="badge">${bill.calls.size()}</span> calls for <g:formatNumber number="${bill.callTotalCost}" type="currency" currencyCode="GBP"/>
        </h4>

        <div class="clearfix">
          <a role="button" class="pull-right callsViewToggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
            Show calls
            <i class="fa fa-chevron-right"></i>
          </a>
        </div>
