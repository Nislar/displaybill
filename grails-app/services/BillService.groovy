...
class BillService {
    ...
    Bill fetchCustomersLatestBill() {
        ...
        new Bill(callTotalCost: responseBody.callCharges.total,
                dueDate: new SimpleDateFormat( DATE_FORMAT ).parse(responseBody.statement.due),
                endDate: new SimpleDateFormat( DATE_FORMAT ).parse(responseBody.statement.period.to),
                generated: new SimpleDateFormat( DATE_FORMAT ).parse(responseBody.statement.generated),
                startDate: new SimpleDateFormat( DATE_FORMAT ).parse(responseBody.statement.period.from),
